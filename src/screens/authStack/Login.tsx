        ...
        <Text style={styles.subTitle}>
          ...
          <ReusableModal
            ...
            <Text style={styles.termsText}>
              Welcome to 4 Our Life ("the App"), a healthcare application
              operated by 4th Pay Ltd. ("we," "us," or "our"), a company
              registered in Ghana. These Terms of Service ("Terms") govern your
              access to and use of our mobile application, website, and
              services.
            </Text>
            <Text style={styles.termsText}>
            ...
            <Text style={styles.termsBullet}>
              ...
              you are between 13 - 17 years old
            </Text>
            <Text style={styles.termsBullet}>
              • Be a resident of Ghana or have valid identification recognized
            ...
            <Text style={styles.termsText}>
              The App is designed to provide general health information and is
              not intended to:
            </Text>
            <Text style={styles.termsBullet}>
            ...
            <Text style={styles.termsText}>
              ...
              digital downloads, and software, are the exclusive property of 4
              Our Life (4th Pay Ltd.) or its licensors and are protected by
              Ghanaian and international copyright, trademark, and other
            ...
            <Text style={styles.termsBullet}>
              ...
              to derive source code from the App
            </Text>
            <Text style={styles.termsBullet}>
            ...
            <Text style={styles.termsText}>
              ...
              Privacy Policy and the Data Protection Act, 2012 (Act 843). By
              using our App, you consent to such processing.
            </Text>
            ...
            <Text style={styles.termsText}>
              We implement additional safeguards for sensitive health
            ...
            <Text style={styles.termsBullet}>
              • With third-party service providers who assist in providing the
              App
            </Text>
            <Text style={styles.termsBullet}>
            ...
            <Text style={styles.termsText}>
              Your use of such third-party services is subject to their
            ...
            <Text style={styles.termsText}>
              ...
              to these Terms or the App shall not exceed the amount of fees you
              paid to us during the three (3) months preceding the claim, or
              GH₵500 if you have not paid any fees.
            </Text>

            <Text style={styles.termsSectionTitle}>13. Indemnification</Text>
            <Text style={styles.termsText}>
              You agree to indemnify, defend, and hold harmless 4 Our Life and
            ...
            <Text style={styles.termsText}>
              ...
              prior notice or liability, for any reason, including if:
            </Text>
            ...
            <Text style={styles.termsText}>
              ...
              changes, we will provide notice through the App or by other means.
              Your continued use of the App after such notice constitutes your
            ...
            <Text style={styles.termsText}>
              ...
              the entire agreement between you and 4 Our Life concerning the
              App.
            </Text>
