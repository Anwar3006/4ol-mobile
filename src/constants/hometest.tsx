    ...
    },
    {
      ...
      icon: (
        <Image
          ...
          resizeMode="contain"
          style={{width: getScaledValue(25), height: getScaledValue(26)}}
        />
      ),
      title: 'Pharmacy',
      screen: 'TopRated',
    ...
    },
    {
      ...
      icon: (
        <Image
          ...
          resizeMode="contain"
          style={{width: getScaledValue(40), height: getScaledValue(26)}}
        />
      ),
      title: 'Plasence',
    ...
    },
    {
      ...
      icon: (
        <Image
          ...
          style={{width: getScaledValue(30), height: getScaledValue(26)}}
        />
      ),
      title: 'Physiotherapy',
      screen: 'TopRated',
